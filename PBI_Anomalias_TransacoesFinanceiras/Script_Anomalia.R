...
indices_historico = previsoes_historico[which(previsoes_historico$anomaly_score > 0.62)] # nolint: line_length_linter.
...
indices_novos_dados = previsoes_novos_dados[which(previsoes_novos_dados$anomaly_score > 0.62)] # nolint: line_length_linter, line_length_linter.
...
# Criando o box plot
ggplot(previsoes_novos_dados, aes(x = status, y = anomaly_score, fill = status)) + # nolint # nolint: line_length_linter.
  geom_boxplot() +
